...
func InitializeApp() (*App, error) {
	...
	hostUrlRepositoryImpl := repository.NewHostUrlRepositoryImpl(db)
	hostUrlServiceImpl := sso.NewHostUrlServiceImpl(hostUrlRepositoryImpl, sessionManager, sugaredLogger)
	userAuthHandlerImpl := restHandler.NewUserAuthHandlerImpl(userAuthServiceImpl, validate, sugaredLogger, enforcerImpl, pubSubClient, userServiceImpl, ssoLoginServiceImpl, hostUrlServiceImpl)
